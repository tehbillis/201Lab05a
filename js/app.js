...
function sumArray(sumArr) { //eslint-disable-line
  ...
  return [theSum, sumArr.join(',') + ' was passed in as an array of numbers, and ' + theSum + ' is their sum.'];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for (let i = 0; i <= multArr.length-1; i++) {
    theProduct = multiply(theProduct, multArr[i])[0];
  }

  return [theProduct, 'The numbers ' + multArr.join(',') + ' have a product of ' + theProduct + '.'];
}
